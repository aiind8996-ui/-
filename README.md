...
const base=["तुझसे प्यार तो हुआ था, पर तेरे खर्चे देखकर अब डर भी लगता है!",
  ...
  "तेरे प्यार का Effect ऐसा – अब घड़ी भी तेरे Time Zone में चलती है!",
  "तेरी हाँ सुनने के बाद Network Full दिखने लगा!",
  "तू हँस दे तो Data Free लगता है!",
  "तेरे लिए दिल तो क्या, बैलेंस भी खत्म कर दूँ!",
  "तू Online आई और मेरा मूड Update हो गया!",
  "तेरा प्यार App जैसा है – Download किया, अब Delete नहीं होता!",
  "तेरे बिना सब कुछ Error दिखाता है!",
  "तू बोली – 'तुम्हें मेरी याद आती है?' – मैंने कहा '24x7 Background में चलती है!'",
  "तेरी Smile देख कर दिल ने कहा – 'Unlimited Pack मिल गया!'",
  "तू Offline हो जाए तो मेरा दिल Airplane Mode में चला जाता है!",
